...
AABCharacterPlayer::AABCharacterPlayer()
{
	...
	static ConstructorHelpers::FObjectFinder<UInputAction> InputActionAttackMoveRef(TEXT("/Script/EnhancedInput.InputAction'/Game/ArenaBattle/Input/Actions/IA_Attack.IA_Attack'"));
